                                                      ...
                                                      const UT_StubContext_t *Context)
{
    ...
    MD_DWELL_TBL_TEST_GlobalLoadTable.Enabled = MD_Dwell_States_ENABLED;
...
void MD_InitControlStructures_Test(void)
{
    ...
    UtAssert_True(MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].Enabled == 0,
                  "MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].Enabled == 0");
    UtAssert_True(MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].AddrCount == 0,
                  "MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].AddrCount == 0");
    UtAssert_True(MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].Rate == 0,
    ...
    UtAssert_True(MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].DataSize == 0,
                  "MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].DataSize == 0");
    UtAssert_True(MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].Filler == 0,
                  "MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].Filler == 0");

    UtAssert_True(MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES - 1].Enabled == 0,
                  "MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES - 1].Enabled == 0");
    UtAssert_True(MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES - 1].AddrCount == 0,
                  "MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES - 1].AddrCount == 0");
    UtAssert_True(MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES - 1].Rate == 0,
    ...
    UtAssert_True(MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES - 1].DataSize == 0,
                  "MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES - 1].DataSize == 0");
    UtAssert_True(MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES - 1].Filler == 0,
                  "MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES - 1].Filler == 0");
    ...
    UtAssert_True(MD_AppData.MD_DwellTables[0].Entry[MD_INTERFACE_DWELL_TABLE_SIZE / 2].Length == 0,
                  "MD_AppData.MD_DwellTables[0].Entry[MD_INTERFACE_DWELL_TABLE_SIZE / 2].Length == 0");
    UtAssert_True(MD_AppData.MD_DwellTables[0].Entry[MD_INTERFACE_DWELL_TABLE_SIZE / 2].Delay == 0,
                  "MD_AppData.MD_DwellTables[0].Entry[MD_INTERFACE_DWELL_TABLE_SIZE / 2].Delay == 0");
    UtAssert_True(MD_AppData.MD_DwellTables[0].Entry[MD_INTERFACE_DWELL_TABLE_SIZE / 2].ResolvedAddress == 0,
                  "MD_AppData.MD_DwellTables[0].Entry[MD_INTERFACE_DWELL_TABLE_SIZE / 2].ResolvedAddress == 0");

    UtAssert_True(MD_AppData.MD_DwellTables[0].Entry[MD_INTERFACE_DWELL_TABLE_SIZE - 1].Length == 0,
                  "MD_AppData.MD_DwellTables[0].Entry[MD_INTERFACE_DWELL_TABLE_SIZE - 1].Length == 0");
    UtAssert_True(MD_AppData.MD_DwellTables[0].Entry[MD_INTERFACE_DWELL_TABLE_SIZE - 1].Delay == 0,
                  "MD_AppData.MD_DwellTables[0].Entry[MD_INTERFACE_DWELL_TABLE_SIZE - 1].Delay == 0");
    UtAssert_True(MD_AppData.MD_DwellTables[0].Entry[MD_INTERFACE_DWELL_TABLE_SIZE - 1].ResolvedAddress == 0,
                  "MD_AppData.MD_DwellTables[0].Entry[MD_INTERFACE_DWELL_TABLE_SIZE - 1].ResolvedAddress == 0");
...
void MD_InitSoftwareBusServices_Test_Nominal(void)
{
    ...
    UtAssert_True(MD_AppData.MD_DwellPkt[MD_INTERFACE_NUM_DWELL_TABLES / 2].Payload.Signature[0] == '\0',
                  "MD_AppData.MD_DwellPkt[MD_INTERFACE_NUM_DWELL_TABLES/2].Payload.Signature[0] == ''");
    UtAssert_True(MD_AppData.MD_DwellPkt[MD_INTERFACE_NUM_DWELL_TABLES - 1].Payload.Signature[0] == '\0',
                  "MD_AppData.MD_DwellPkt[MD_INTERFACE_NUM_DWELL_TABLES - 1].Payload.Signature[0] == ''");
#endif
...
void MD_InitTableServices_Test_GetAddressErrorAndLoadError(void)
{
    ...
    UtAssert_True(MD_AppData.MD_DwellTables[1].Enabled == MD_Dwell_States_DISABLED,
                  "MD_AppData.MD_DwellTables[1].Enabled == MD_Dwell_States_DISABLED");
    UtAssert_True(MD_AppData.MD_DwellTables[2].Enabled == MD_Dwell_States_DISABLED,
                  "MD_AppData.MD_DwellTables[2].Enabled == MD_Dwell_States_DISABLED");
    UtAssert_True(MD_AppData.MD_DwellTables[3].Enabled == MD_Dwell_States_DISABLED,
                  "MD_AppData.MD_DwellTables[3].Enabled == MD_Dwell_States_DISABLED");
...
void MD_ManageDwellTable_Test_UpdatePendingDwellStreamDisabled(void)
{
    ...
    /* Set to satisfy condition "MD_LoadTablePtr->Enabled == MD_Dwell_States_DISABLED" and to prevent a core dump by
...
void MD_HkStatus_Test(void)
{
    ...
    MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].AddrCount    = 7;
    MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].Rate         = 8;
    MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].PktOffset    = 9;
    MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].DataSize     = 10;
    MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].CurrentEntry = 11;
    MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES / 2].Countdown    = 12;

    MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES - 1].AddrCount    = 13;
    MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES - 1].Rate         = 14;
    MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES - 1].PktOffset    = 15;
    MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES - 1].DataSize     = 16;
    MD_AppData.MD_DwellTables[MD_INTERFACE_NUM_DWELL_TABLES - 1].CurrentEntry = 17;
    ...
    UtAssert_True(MD_AppData.HkPkt.Payload.DwellTblAddrCount[MD_INTERFACE_NUM_DWELL_TABLES / 2] == 7,
                  "MD_AppData.HkPkt.Payload.DwellTblAddrCount[MD_INTERFACE_NUM_DWELL_TABLES / 2] == 7");
    UtAssert_True(MD_AppData.HkPkt.Payload.NumWaitsPerPkt[MD_INTERFACE_NUM_DWELL_TABLES / 2] == 8,
                  "MD_AppData.HkPkt.Payload.NumWaitsPerPkt[MD_INTERFACE_NUM_DWELL_TABLES / 2]    == 8");
    UtAssert_True(MD_AppData.HkPkt.Payload.DwellPktOffset[MD_INTERFACE_NUM_DWELL_TABLES / 2] == 9,
                  "MD_AppData.HkPkt.Payload.DwellPktOffset[MD_INTERFACE_NUM_DWELL_TABLES / 2]    == 9");
    UtAssert_True(MD_AppData.HkPkt.Payload.ByteCount[MD_INTERFACE_NUM_DWELL_TABLES / 2] == 10,
                  "MD_AppData.HkPkt.Payload.ByteCount[MD_INTERFACE_NUM_DWELL_TABLES / 2]         == 10");
    UtAssert_True(MD_AppData.HkPkt.Payload.DwellTblEntry[MD_INTERFACE_NUM_DWELL_TABLES / 2] == 11,
                  "MD_AppData.HkPkt.Payload.DwellTblEntry[MD_INTERFACE_NUM_DWELL_TABLES / 2]     == 11");
    UtAssert_True(MD_AppData.HkPkt.Payload.Countdown[MD_INTERFACE_NUM_DWELL_TABLES / 2] == 12,
                  "MD_AppData.HkPkt.Payload.Countdown[MD_INTERFACE_NUM_DWELL_TABLES / 2]         == 12");

    UtAssert_True(MD_AppData.HkPkt.Payload.DwellTblAddrCount[MD_INTERFACE_NUM_DWELL_TABLES - 1] == 13,
                  "MD_AppData.HkPkt.Payload.DwellTblAddrCount[MD_INTERFACE_NUM_DWELL_TABLES - 1] == 13");
    UtAssert_True(MD_AppData.HkPkt.Payload.NumWaitsPerPkt[MD_INTERFACE_NUM_DWELL_TABLES - 1] == 14,
                  "MD_AppData.HkPkt.Payload.NumWaitsPerPkt[MD_INTERFACE_NUM_DWELL_TABLES - 1]    == 14");
    UtAssert_True(MD_AppData.HkPkt.Payload.DwellPktOffset[MD_INTERFACE_NUM_DWELL_TABLES - 1] == 15,
                  "MD_AppData.HkPkt.Payload.DwellPktOffset[MD_INTERFACE_NUM_DWELL_TABLES - 1]    == 15");
    UtAssert_True(MD_AppData.HkPkt.Payload.ByteCount[MD_INTERFACE_NUM_DWELL_TABLES - 1] == 16,
                  "MD_AppData.HkPkt.Payload.ByteCount[MD_INTERFACE_NUM_DWELL_TABLES - 1]         == 16");
    UtAssert_True(MD_AppData.HkPkt.Payload.DwellTblEntry[MD_INTERFACE_NUM_DWELL_TABLES - 1] == 17,
                  "MD_AppData.HkPkt.Payload.DwellTblEntry[MD_INTERFACE_NUM_DWELL_TABLES - 1]     == 17");
    UtAssert_True(MD_AppData.HkPkt.Payload.Countdown[MD_INTERFACE_NUM_DWELL_TABLES - 1] == 18,
                  "MD_AppData.HkPkt.Payload.Countdown[MD_INTERFACE_NUM_DWELL_TABLES - 1]         == 18");
