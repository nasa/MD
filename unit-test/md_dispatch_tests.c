...
void MD_ProcessCommandPacket_Test_Wakeup(void)
{
    ...
    UtAssert_True(call_count_MD_DwellLoop == 1,
                  "MD_DwellLoop was called %u time(s), expected 1",
...
void MD_ProcessCommandPacket_Test_SendHk(void)
{
    ...
    UtAssert_True(call_count_MD_HkStatus == 1, "MD_HkStatus was called %u time(s), expected 1", call_count_MD_HkStatus);
    UtAssert_True(call_count_CFE_EVS_SendEvent == 0,
                  "CFE_EVS_SendEvent was called %u time(s), expected 0",
                  call_count_CFE_EVS_SendEvent);
...
void MD_ProcessCommandPacket_Test_Cmd(void)
{
    ...
    UtAssert_True(call_count_MD_ExecRequest == 0,
                  "MD_ExecRequest was called %u time(s), expected 1",
...
void MD_ExecRequest_Test_Noop(void)
{
    ...
    UtAssert_True(call_count_MD_NoopCmd == 1, "MD_NoopCmd was called %u time(s), expected 1", call_count_MD_NoopCmd);
    UtAssert_True(call_count_CFE_EVS_SendEvent == 0,
                  "CFE_EVS_SendEvent was called %u time(s), expected 0",
                  call_count_CFE_EVS_SendEvent);
}
...
void MD_ExecRequest_Test_Reset(void)
{
    ...
    UtAssert_True(call_count_MD_ResetCountersCmd == 1,
                  "MD_ResetCountersCmd was called %u time(s), expected 1",
...
void MD_ExecRequest_Test_StartDwell(void)
{
    ...
    UtAssert_True(call_count_MD_StartDwellCmd == 1,
                  "MD_StartDwellCmd was called %u time(s), expected 1",
...
void MD_ExecRequest_Test_StopDwell(void)
{
    ...
    UtAssert_True(call_count_MD_StopDwellCmd == 1,
                  "MD_StopDwellCmd was called %u time(s), expected 1",
...
void MD_ExecRequest_Test_JamDwell(void)
{
    ...
    UtAssert_True(call_count_MD_JamDwellCmd == 1,
                  "MD_JamDwellCmd was called %u time(s), expected 1",
...
void MD_ExecRequest_Test_SetSignature(void)
{
    ...
    UtAssert_True(call_count_MD_SetSignatureCmd == 1,
                  "MD_SetSignatureCmd was called %u time(s), expected 1",
...
{
    UtTest_Add(MD_ProcessCommandPacket_Test_Wakeup,
               MD_Test_Setup,
               MD_Test_TearDown,
               "MD_ProcessCommandPacket_Test_Wakeup");
    UtTest_Add(MD_ProcessCommandPacket_Test_SendHk,
               MD_Test_Setup,
               MD_Test_TearDown,
               "MD_ProcessCommandPacket_Test_SendHk");
    UtTest_Add(MD_ProcessCommandPacket_Test_Cmd, MD_Test_Setup, MD_Test_TearDown, "MD_ProcessCommandPacket_Test_Cmd");
    UtTest_Add(MD_ProcessCommandPacket_Test_InvalidMsgId,
               MD_Test_Setup,
               MD_Test_TearDown,
               "MD_ProcessCommandPacket_Test_InvalidMsgId");
    UtTest_Add(MD_ProcessCommandPacket_Test_NullPtr,
               MD_Test_Setup,
               MD_Test_TearDown,
               "MD_ProcessCommandPacket_Test_NullPtr");
    ...
    UtTest_Add(MD_ExecRequest_Test_InvalidCommandCode,
               MD_Test_Setup,
               MD_Test_TearDown,
               "MD_ExecRequest_Test_InvalidCommandCode");
    UtTest_Add(MD_ExecRequest_Test_InvalidMsgLength,
               MD_Test_Setup,
               MD_Test_TearDown,
               "MD_ExecRequest_Test_InvalidMsgLength");
