...
FOR i = 1 to MD_NUM_DWELL_TABLES DO
  ...
  write "** Trying to upload '",loadFileName

  s ftp_file("CF:0/apps-rc", loadFileName, loadFileName, hostCPU,"P")
  wait 5
ENDDO
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=1 EntryId=1 FieldLength=1 DwellDelay=1 Offset=0 SymName="""""
...
if (SCX_CPU1_find_event[1].num_found_messages != 1) THEN
  write "<!> Failed (4000) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", MD_JAM_DWELL_INF_EID, "."
  ut_setrequirements MD_4000, "F"
else
  write "<*> Passed (4000) - Jam Dwell command sent properly."
  ut_setrequirements MD_4000, "P"
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=1 EntryId=2 FieldLength=1 DwellDelay=0 Offset=1 SymName="""""
if (UT_SC_Status <> UT_SC_Success) then
  write "<!> Failed (4000) - Jam Dwell command not sent properly (", UT_SC_Status, ")."
  ut_setrequirements MD_4000, "F"
else
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=1 EntryId=3 FieldLength=0 DwellDelay=0 Offset=0 SymName="""""
if (UT_SC_Status <> UT_SC_Success) then
  write "<!> Failed (4000) - Jam Dwell command not sent properly (", UT_SC_Status, ")."
  ut_setrequirements MD_4000, "F"
else
...
if (SCX_CPU1_find_event[1].num_found_messages != 1) THEN
  write "<!> Failed (4000) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", MD_JAM_NULL_DWELL_INF_EID, "."
  ut_setrequirements MD_4000, "F"
else
  write "<*> Passed (4000) - Jam Dwell command sent properly."
  ut_setrequirements MD_4000, "P"
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=2 EntryId=1 FieldLength=2 DwellDelay=1 Offset=2 SymName="""""
if (UT_SC_Status <> UT_SC_Success) then
  write "<!> Failed (4000) - Jam Dwell command not sent properly (", UT_SC_Status, ")."
  ut_setrequirements MD_4000, "F"
else
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=2 EntryId=2 FieldLength=2 DwellDelay=0 Offset=2 SymName="""""
if (UT_SC_Status <> UT_SC_Success) then
  write "<!> Failed (4000) - Jam Dwell command not sent properly (", UT_SC_Status, ")."
  ut_setrequirements MD_4000, "F"
else
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=2 EntryId=3 FieldLength=0 DwellDelay=0 Offset=0 SymName="""""
if (UT_SC_Status <> UT_SC_Success) then
  write "<!> Failed (4000) - Jam Dwell command not sent properly (", UT_SC_Status, ")."
  ut_setrequirements MD_4000, "F"
else
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=3 EntryId=1 FieldLength=4 DwellDelay=1 Offset=4 SymName="""""
if (UT_SC_Status <> UT_SC_Success) then
  write "<!> Failed (4000) - Jam Dwell command not sent properly (", UT_SC_Status, ")."
  ut_setrequirements MD_4000, "F"
else
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=3 EntryId=2 FieldLength=4 DwellDelay=0 Offset=8 SymName="""""
if (UT_SC_Status <> UT_SC_Success) then
  write "<!> Failed (4000) - Jam Dwell command not sent properly (", UT_SC_Status, ")."
  ut_setrequirements MD_4000, "F"
else
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=3 EntryId=3 FieldLength=0 DwellDelay=0 Offset=0 SymName="""""
if (UT_SC_Status <> UT_SC_Success) then
  write "<!> Failed (4000) - Jam Dwell command not sent properly (", UT_SC_Status, ")."
  ut_setrequirements MD_4000, "F"
else
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=4 EntryId=1 FieldLength=1 DwellDelay=1 Offset=8 SymName="""""
if (UT_SC_Status <> UT_SC_Success) then
  write "<!> Failed (4000) - Jam Dwell command not sent properly (", UT_SC_Status, ")."
  ut_setrequirements MD_4000, "F"
else
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=4 EntryId=2 FieldLength=1 DwellDelay=0 Offset=9 SymName="""""
if (UT_SC_Status <> UT_SC_Success) then
  write "<!> Failed (4000) - Jam Dwell command not sent properly (", UT_SC_Status, ")."
  ut_setrequirements MD_4000, "F"
else
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=4 EntryId=3 FieldLength=0 DwellDelay=0 Offset=0 SymName="""""
if (UT_SC_Status <> UT_SC_Success) then
  write "<!> Failed (4000) - Jam Dwell command not sent properly (", UT_SC_Status, ")."
  ut_setrequirements MD_4000, "F"
else
...
write ";********************************************************************"
if (SCX_CPU1_MD_DwPktOffset[1] = 0) or (SCX_CPU1_MD_DwTblEntry[1] = 0) or (SCX_CPU1_MD_CountDown[1] = 0) then
...
ut_sendcmd "SCX_CPU1_MD_StopDwell TableMask=b'0001'"
if (UT_SC_Status = UT_SC_Success) then
...
; Check MD_EnableMask
if (SCX_CPU1_MD_EnableMask = b'1010') then
...
if (SCX_CPU1_MD_DwPktOffset[1] = 0) and (SCX_CPU1_MD_DwTblEntry[1] = 0) and (SCX_CPU1_MD_CountDown[1] = 0) then
...
write ";********************************************************************"
if (SCX_CPU1_MD_DwPktOffset[2] = 0) or (SCX_CPU1_MD_DwTblEntry[2] = 0) or (SCX_CPU1_MD_CountDown[2] = 0) then
...
ut_sendcmd "SCX_CPU1_MD_StopDwell TableMask=b'0010'"
if (UT_SC_Status = UT_SC_Success) then
  write "<*> Passed (1004;2001) - Stop Dwell command sent properly."
  ut_setrequirements MD_1004, "P"
  ut_setrequirements MD_2001, "P"
...
; Check MD_DwellPktOffset, MD_DwellTblEntry & MD_CountDown
if (SCX_CPU1_MD_DwPktOffset[2] = 0) and (SCX_CPU1_MD_DwTblEntry[2] = 0) and (SCX_CPU1_MD_CountDown[2] = 0) then
...
write ";********************************************************************"
if (SCX_CPU1_MD_DwPktOffset[4] = 0) or (SCX_CPU1_MD_DwTblEntry[4] = 0) or (SCX_CPU1_MD_CountDown[4] = 0) then
...
ut_sendcmd "SCX_CPU1_MD_StopDwell TableMask=b'1000'"
if (UT_SC_Status = UT_SC_Success) then
  write "<*> Passed (1004;2001) - Stop Dwell command sent properly."
  ut_setrequirements MD_1004, "P"
  ut_setrequirements MD_2001, "P"
...
; Check MD_DwellPktOffset, MD_DwellTblEntry & MD_CountDown
if (SCX_CPU1_MD_DwPktOffset[4] = 0) and (SCX_CPU1_MD_DwTblEntry[4] = 0) and (SCX_CPU1_MD_CountDown[4] = 0) then
...
ut_sendcmd "SCX_CPU1_MD_StopDwell TableMask=b'1001'"
if (UT_SC_Status = UT_SC_Success) then
  write "<*> Passed (1004;2001) - Stop Dwell command sent properly."
  ut_setrequirements MD_1004, "P"
  ut_setrequirements MD_2001, "P"
...
; Check MD_EnableMask
if (SCX_CPU1_MD_EnableMask = b'0110') then
...
if (SCX_CPU1_MD_DwPktOffset[3] = 0) or (SCX_CPU1_MD_DwTblEntry[3] = 0) or (SCX_CPU1_MD_CountDown[3] = 0) then
...
if (SCX_CPU1_MD_DwPktOffset[3] = 0) and (SCX_CPU1_MD_DwTblEntry[3] = 0) and (SCX_CPU1_MD_CountDown[3] = 0) then
...
; Check MD_EnableMask
if (SCX_CPU1_MD_EnableMask = b'0100') then
...
ut_sendcmd "SCX_CPU1_MD_StartDwell TableMask=b'0101'"
if (UT_SC_Status = UT_SC_Success) then
  write "<*> Passed (1004;2000) - Start Dwell command sent properly."
  ut_setrequirements MD_1004, "P"
  ut_setrequirements MD_2000, "P"
...
; Check MD_EnableMask
if (SCX_CPU1_MD_EnableMask = b'0101') then
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=2 EntryId=1 FieldLength=2 DwellDelay=0 Offset=2 SymName="""""
if (UT_SC_Status <> UT_SC_Success) then
  write "<!> Failed (4000) - Jam Dwell command not sent properly (", UT_SC_Status, ")."
  ut_setrequirements MD_4000, "F"
else
...
if (SCX_CPU1_find_event[2].num_found_messages = 1) then
  ...
  write "<*> Event Msg ",SCX_CPU1_find_event[2].eventid," Found!"
...
; Check MD_EnableMask
if (SCX_CPU1_MD_EnableMask = b'0010') then
...
; table IDs
ut_setupevents "SCX", "CPU1", {MDAppName}, MD_EMPTY_TBLMASK_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_MD_CMDEC + 1

/SCX_CPU1_MD_StartDwell TableMask=x'2000'
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1003) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",MD_EMPTY_TBLMASK_ERR_EID, "."
  ut_setrequirements MD_1003, "F"
endif
...
/SCX_CPU1_MD_StopDwell TableMask=x'2000'
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_md_CtrlCmds                                 "
write ";*********************************************************************"
ENDPROC
