...
write ";*********************************************************************"
write ";             Command a Power-On Reset on CPU1. "
write ";********************************************************************"
...
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Offset = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_SymName = "TestData"

; Entry #2
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[2].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[2].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[2].MD_TLE_Offset = 4
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[2].MD_TLE_SymName = "TestData"

; Entry #3
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[3].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[3].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[3].MD_TLE_Offset = 6
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[3].MD_TLE_SymName = "TestData"

; Entry #4
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[4].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[4].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[4].MD_TLE_Offset = 8
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[4].MD_TLE_SymName = "TestData"

; Entry #5
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[5].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[5].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[5].MD_TLE_Offset = 10
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[5].MD_TLE_SymName = "TestData"

; Entry #6
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[6].MD_TLE_Length = 4
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[6].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[6].MD_TLE_Offset = 12
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[6].MD_TLE_SymName = "TestData"

; Entry #7
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[7].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[7].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[7].MD_TLE_Offset = 16
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[7].MD_TLE_SymName = "TestData"

; Entry #8
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[8].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[8].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[8].MD_TLE_Offset = 18
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[8].MD_TLE_SymName = "TestData"

; Entry #9
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[9].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[9].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[9].MD_TLE_Offset = 20
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[9].MD_TLE_SymName = "TestData"

; Entry #10
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[10].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[10].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[10].MD_TLE_Offset = 22
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[10].MD_TLE_SymName = "TestData"

; Entry #11
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[11].MD_TLE_Length = 4
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[11].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[11].MD_TLE_Offset = 24
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[11].MD_TLE_SymName = "TestData"

; Entry #12 - with a delay of 4
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[12].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[12].MD_TLE_Delay = 4
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[12].MD_TLE_Offset = 28
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[12].MD_TLE_SymName = "TestData"

; Terminator entry
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[13].MD_TLE_Length = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[13].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[13].MD_TLE_Offset = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[13].MD_TLE_SymName = "TestData"
...
s create_tbl_file_from_cvt (hostCPU,dwell_tbl1_load_appid,"Dwell Table #1 Load", "md_dwl_ld_sg_tbl1",MDTblName1, "SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Enabled", "SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[13]")
...
if (SCX_CPU1_find_event[2].num_found_messages = 1) then
  write "<*> Passed (3002;3002.4) - Dwell Table #1 Activated. Event Msg ",SCX_CPU1_find_event[2].eventid," Found!"
...
IF (SCX_CPU1_MD_DwlPkt1NumAddresses = 12) THEN
...
IF (scx_cpu1_MD_DwlPkt1PktDataSize = 30) THEN
...
IF (scx_cpu1_MD_DwlPkt1Rate = 4) THEN
...
ut_tlmwait  SCX_CPU1_MD_DwlPkt1TableId, 1
...
for i = 1 to 15 do
  ...
  for j = 1 to 34 do
    dwelldata[i,j] = SCX_CPU1_MD_DwlPkt1DwellData[j]
  enddo
enddo
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=2 EntryId=1 FieldLength=4 DwellDelay=4 Offset=0 SymName=""TestData"""
if (UT_SC_Status = UT_SC_Success) then
...
s get_tbl_to_cvt (ramDir,MDTblName2,"A","cpu1_symdump222",hostCPU,dwell_tbl2_load_pkt)
...
if (SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_Length = 4) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_Delay = 4) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_Offset = 0) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_SymName = "TestData") then
  ...
  write "- Expected Length of 4 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_Length
  write "- Expected Delay of 2 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_Delay
  write "- Expected Offset of 0 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_Offset
  write "- Expected SymName of 'TestData' - table = ",SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_SymName
  ut_setrequirements MD_4000, "F"
endif
...
; Verify number of addresses of the packet
IF (SCX_CPU1_MD_DwlPkt2NumAddresses = 2) THEN
...
; Verify number of bytes of data of the packet
IF (scx_cpu1_MD_DwlPkt2PktDataSize = 6) THEN
...
; Check MD_EnableMask
if (SCX_CPU1_MD_EnableMask = b'0111') then
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=3 EntryId=3 FieldLength=2 DwellDelay=1 Offset=12 SymName=""TestData"""
if (UT_SC_Status = UT_SC_Success) then
  write "<*> Passed (1004,4000,4000.4) - Jam Dwell command sent properly."
  ut_setrequirements MD_1004, "P"
  ut_setrequirements MD_4000, "P"
...
; Dump the current active dwell load table
ut_setupevents SCX, CPU1, CFE_TBL, CFE_TBL_WRITE_DUMP_INF_EID, INFO, 1

cmdcnt = SCX_CPU1_TBL_CMDPC+1

s get_tbl_to_cvt (ramDir,MDTblName3,"A","cpu1_symdump_233",hostCPU,dwell_tbl3_load_pkt)
...
;; Check the table entry to see if it corresponds to what was jammed
if (SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[3].MD_TLE_Length = 2) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[3].MD_TLE_Delay = 1) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[3].MD_TLE_Offset = 12) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[3].MD_TLE_SymName = "TestData") then
  write "<*> Passed (4000) - The jammed entry has been found in the table."
  ut_setrequirements MD_4000, "P"
else
  write "<!> Failed (4000) - The table did not contain the jammed entry."
  write "- Expected Length of 2 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_Length
  write "- Expected Delay of 1 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_Delay
  write "- Expected Offset of 12 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_Offset
  write "- Expected SymName of 'TestData' - table = ",SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_SymName
  ut_setrequirements MD_4000, "F"
endif
...
; Verify table id of the packet
IF (SCX_CPU1_MD_DwlPkt3TableId = 3) THEN
...
; Verify number of addresses of the packet
IF (SCX_CPU1_MD_DwlPkt3NumAddresses = 3) THEN
...
; Verify number of bytes of data of the packet
IF (scx_cpu1_MD_DwlPkt3PktDataSize = 8) THEN
...
; Verify rate of the packet
IF (scx_cpu1_MD_DwlPkt3Rate = 2) THEN
...
for i = 1 to 15 do
  ...
  ; Collect the data from the packet
  for j = 1 to 12 do
    dwelldata[i,j] = SCX_CPU1_MD_DwlPkt3DwellData[j]
  enddo
enddo
...
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_SymName = "MD Invalid Symbol"
...
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Delay = 1
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Offset = x'8000002'
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_SymName = "TestData"
...
if (SCX_CPU1_find_event[3].num_found_messages = 1) then
  write "<*> Passed (3002.2) - Validation failed due to range error. Event Msg ",SCX_CPU1_find_event[3].eventid," Found!"
  ut_setrequirements MD_3002_2, "P"
else
...
if (SCX_CPU1_find_event[3].num_found_messages = 1) then
  write "<*> Passed (3002.2) - Validation failed due to alignment error. Event Msg ",SCX_CPU1_find_event[3].eventid," Found!"
  ut_setrequirements MD_3002_2, "P"
else 
...
/SCX_CPU1_MD_JAMDWELL TableId=1 EntryId=2 FieldLength=2 DwellDelay=0 Offset=0 SymName="MD Invalid Symbol"
...
/SCX_CPU1_MD_JAMDWELL TableId=2 EntryId=1 FieldLength=2 DwellDelay=0 Offset=x'8000004' SymName="TestData"
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  /SCX_CPU1_MD_JAMDWELL TableId=2 EntryId=1 FieldLength=4 DwellDelay=4 Offset=0 SymName="TestData"
  wait 2
endif
...
/SCX_CPU1_MD_JAMDWELL TableId=3 EntryId=3 FieldLength=2 DwellDelay=0 Offset=3 SymName="TestData"
...
s get_tbl_to_cvt (ramDir,MDTblName4,"A","cpu1_symdump381",hostCPU,dwell_tbl4_load_pkt)
...
local savedLength = SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[1].MD_TLE_Length
local savedDelay = SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[1].MD_TLE_Delay 
local savedOffset = SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[1].MD_TLE_Offset
local savedSymName = SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[1].MD_TLE_SymName
...
/SCX_CPU1_MD_JAMDWELL TableId=4 EntryId=1 FieldLength=4 DwellDelay=0 Offset=6 SymName="TestData"
...
if (MD_ENFORCE_DWORD_ALIGN = 0) then
  ...
  /SCX_CPU1_MD_JAMDWELL TableId=4 EntryId=1 FieldLength=savedLength DwellDelay=savedDelay Offset=savedOffset SymName=savedSymName
...
for i = 1 to MD_NUM_DWELL_TABLES do
  ...
  dumpFileName = "cpu1_tbl" & i & "symdmp411"
  if (i = 1) then
  ...
  dataName = "SCX_CPU1_MD_Dwell_Load_Tbl" & i & ".MD_DTL_Enabled"
  tbl_enaFlag[i] = {dataName}
  dataName = "SCX_CPU1_MD_Dwell_Load_Tbl" & i & ".MD_DTL_Signature"
  tbl_signature[i] = {dataName}

  ;; loop for each table entry
  for j = 1 to MD_DWELL_TABLE_SIZE do
    dataName = "SCX_CPU1_MD_Dwell_Load_Tbl" & i & ".MD_DTL_Entry[" & j & "].MD_TLE_Length"
    tbl_length[i,j] = {dataName}
    dataName = "SCX_CPU1_MD_Dwell_Load_Tbl" & i & ".MD_DTL_Entry[" & j & "].MD_TLE_Delay"
    tbl_delay[i,j] = {dataName}
    dataName = "SCX_CPU1_MD_Dwell_Load_Tbl" & i & ".MD_DTL_Entry[" & j & "].MD_TLE_Offset"
    tbl_offset[i,j] = {dataName}
    dataName = "SCX_CPU1_MD_Dwell_Load_Tbl" & i & ".MD_DTL_Entry[" & j & "].MD_TLE_SymName"
...
ut_setupevents "SCX","CPU1","CFE_ES", CFE_ES_START_INF_EID, "INFO", 1
ut_setupevents "SCX","CPU1",{MDAppName},MD_RECOVERED_TBL_VALID_INF_EID,"INFO", 2
ut_setupevents "SCX","CPU1",{MDAppName},MD_INIT_INF_EID, "INFO", 3

s load_start_app (MDAppName,hostCPU,"MD_AppMain")

; Wait for table recovery events
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 4
IF (UT_TW_Status = UT_Success) THEN
...
FOR i = 1 to MD_NUM_DWELL_TABLES DO
  ...
  tableName = MDAppName & ".DWELL_TABLE" & i
  dumpFileName = "cpu1_tbl" & i & "symdmp413"
  if (i = 1) then
    loadPktId = dwell_tbl1_load_pkt
  elseif (i = 2) then
    loadPktId = dwell_tbl2_load_pkt
...
if (SCX_CPU1_MD_EnableMask = b'0111') then
  ...
  write "<!> Failed (9003,9004) - MD_EnableMask is not the expected value!, Got ",SCX_CPU1_MD_EnableMask, " Expected 7"
  ut_setrequirements MD_9003, "F"
  ut_setrequirements MD_9004, "F"

  ; Start the tables so we can finish the test
  /SCX_CPU1_MD_StartDwell TableMask=b'0111'
  wait 5
endif
...
if (SCX_CPU1_MD_AddrCnt[1] = 12) and (SCX_CPU1_MD_Rate[1] = 4) and (SCX_CPU1_MD_DataSize[1] = 30) THEN
  ...
  write "SCX_CPU1_MD_AddrCnt[1] = ", SCX_CPU1_MD_AddrCnt[1], " (Expected 12)"
  write "SCX_CPU1_MD_Rate[1] = ", SCX_CPU1_MD_Rate[1], " (Expected 4)"
  write "SCX_CPU1_MD_DataSize[1] = ", SCX_CPU1_MD_DataSize[1], " (Expected 30)"
  ut_setrequirements MD_9003, "F"
  ut_setrequirements MD_9004, "F"
endif

; SECOND table should have address count 2, rate 4 and data size 6 - it was not modified
if (SCX_CPU1_MD_AddrCnt[2] = 2) and (SCX_CPU1_MD_Rate[2] = 4) and (SCX_CPU1_MD_DataSize[2] = 6) THEN
  ...
  write "SCX_CPU1_MD_AddrCnt[2] = ", SCX_CPU1_MD_AddrCnt[2], " (Expected 2)"
  write "SCX_CPU1_MD_Rate[2] = ", SCX_CPU1_MD_Rate[2], " (Expected 2)"
  write "SCX_CPU1_MD_DataSize[2] = ", SCX_CPU1_MD_DataSize[2], " (Expected 6)"
  ut_setrequirements MD_9003, "F"
  ut_setrequirements MD_9004, "F"
endif

; THIRD table should have address count 3, rate 2 and data size 8
if (SCX_CPU1_MD_AddrCnt[3] = 3) and (SCX_CPU1_MD_Rate[3] = 2) and (SCX_CPU1_MD_DataSize[3] = 8) THEN
  ...
  write "SCX_CPU1_MD_AddrCnt[3] = ", SCX_CPU1_MD_AddrCnt[3], " (Expected 3)"
  write "SCX_CPU1_MD_Rate[3] = ", SCX_CPU1_MD_Rate[3], " (Expected 2)"
  write "SCX_CPU1_MD_DataSize[3] = ", SCX_CPU1_MD_DataSize[3], " (Expected 8)"
  ut_setrequirements MD_9003, "F"
  ut_setrequirements MD_9004, "F"
endif

; LAST table should have address count 2, rate 1 and data size 2
if (SCX_CPU1_MD_AddrCnt[4] = 2) and (SCX_CPU1_MD_Rate[4] = 1) and (SCX_CPU1_MD_DataSize[4] = 2) THEN
  ...
  write "SCX_CPU1_MD_AddrCnt[4] = ", SCX_CPU1_MD_AddrCnt[4], " (Expected 2)"
  write "SCX_CPU1_MD_Rate[4] = ", SCX_CPU1_MD_Rate[4], " (Expected 1)"
  write "SCX_CPU1_MD_DataSize[4] = ", SCX_CPU1_MD_DataSize[4], " (Expected 2)"
  ut_setrequirements MD_9003, "F"
  ut_setrequirements MD_9004, "F"
endif
...
LOCAL entryLength, entryDelay
; get the address of the test data area
; Need to determine if this changed, If yes, then the dwell table addresses that
; are not symbols + offset will not be correct
; Only Table 2 and 3 are affected by this
if (testdata_addr != SCX_CPU1_TST_MD_TSTDATAADR) then
  testdata_addr = SCX_CPU1_TST_MD_TSTDATAADR

  ; JAM correct addresses into Table 2
  entryLength = SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Length
  entryDelay = SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Delay
  ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=2 EntryId=2 FieldLength=entryLength DwellDelay=entryDelay Offset=4 SymName=""TestData"""
  if (UT_SC_Status = UT_SC_Success) then
    write "<*> Passed (1004,4000,4000.4) - Jam Dwell command sent properly."
    ut_setrequirements MD_1004, "P"
    ut_setrequirements MD_4000, "P"
  ...
  ; JAM correct addresses into Table 3
  entryLength = SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[1].MD_TLE_Length
  entryDelay = SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[1].MD_TLE_Delay
  ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=3 EntryId=1 FieldLength=entryLength DwellDelay=entryDelay Offset=6 SymName=""TestData"""
  if (UT_SC_Status = UT_SC_Success) then
    write "<*> Passed (1004,4000,4000.4) - Jam Dwell command sent properly."
    ut_setrequirements MD_1004, "P"
    ut_setrequirements MD_4000, "P"
  ...
  entryLength = SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[2].MD_TLE_Length
  entryDelay = SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[2].MD_TLE_Delay
  ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=3 EntryId=2 FieldLength=entryLength DwellDelay=entryDelay Offset=8 SymName=""TestData"""
  if (UT_SC_Status = UT_SC_Success) then
    write "<*> Passed (1004,4000,4000.4) - Jam Dwell command sent properly."
    ut_setrequirements MD_1004, "P"
    ut_setrequirements MD_4000, "P"
...
for i = 1 to MD_NUM_DWELL_TABLES do
  ...
  tableName = MDAppName & ".DWELL_TABLE" & i
  dumpFileName = "cpu1_tbl" & i & "symdmp421"
  if (i = 1) then
    loadPktId = dwell_tbl1_load_pkt
  elseif (i = 2) then
    loadPktId = dwell_tbl2_load_pkt
...
write ";********************************************************************"
ut_setupevents "SCX","CPU1","CFE_ES", CFE_ES_RESTART_APP_INF_EID, "INFO", 1
ut_setupevents "SCX","CPU1",{MDAppName},MD_RECOVERED_TBL_VALID_INF_EID,"INFO", 2
ut_setupevents "SCX","CPU1",{MDAppName},MD_INIT_INF_EID, "INFO", 3

/SCX_CPU1_ES_RESTARTAPP APPLICATION=MDAppName
wait 5

; WORK-AROUND for RESTARTAPP issue with cFE 6.7.3
;ut_setupevents "SCX", "CPU1", "CFE_ES", CFE_ES_START_INF_EID, "INFO", 1
;
;s load_start_app (MDAppName,hostCPU,"MD_AppMain")
...
FOR i = 1 to MD_NUM_DWELL_TABLES DO
  ...
  tableName = MDAppName & ".DWELL_TABLE" & i
  dumpFileName = "cpu1_tbl" & i & "symdmp423"
  if (i = 1) then
    loadPktId = dwell_tbl1_load_pkt
  elseif (i = 2) then
    loadPktId = dwell_tbl2_load_pkt
...
passed = 1
FOR i = 1 to MD_NUM_DWELL_TABLES DO
  if (SCX_CPU1_MD_AddrCnt[i] = 0) and (SCX_CPU1_MD_Rate[i] = 0) and (SCX_CPU1_MD_DataSize[i] = 0) THEN
    write "<*> Passed (9002) - Dwell Table ", i, " was cleared as expected!"
  else
    passed = 0
    write "<!> Failed (9002) - Dwell Table ", i, " was not cleared!"
    write "SCX_CPU1_MD_AddrCnt[",i,"] = ", SCX_CPU1_MD_AddrCnt[i], " (Expected 0)"
    write "SCX_CPU1_MD_Rate[",i,"] = ", SCX_CPU1_MD_Rate[i], " (Expected 0)"
    write "SCX_CPU1_MD_DataSize[",i,"] = ", SCX_CPU1_MD_DataSize[i], " (Expected 0)"
  endif
ENDDO
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_md_SymTab                                 "
write ";*********************************************************************"
ENDPROC
