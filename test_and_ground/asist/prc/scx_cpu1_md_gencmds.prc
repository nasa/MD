...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {MDAppName}, MD_NOOP_INF_EID, "INFO", 1

ut_sendcmd "SCX_CPU1_MD_NOOP"
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  write "<*> Passed (1000;1004) - Event message ",SCX_CPU1_find_event[1].eventid, " received"
  ut_setrequirements MD_1000, "P"
  ut_setrequirements MD_1004, "P"
else
  write "<!> Failed (1000;1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", MD_NOOP_INF_EID, "."
  ut_setrequirements MD_1000, "F"
  ut_setrequirements MD_1004, "F"
endif
...
if (SCX_CPU1_MD_CMDPC = 0) then
  ;; Send a NOOP command
  /SCX_CPU1_MD_NOOP
  wait 5
endif

if (SCX_CPU1_MD_CMDEC = 0) then
  /raw {rawcmd}
  wait 5
endif

;; Setup for the expected event
ut_setupevents "SCX", "CPU1", {MDAppName}, MD_RESET_CNTRS_DBG_EID, "DEBUG", 1

/SCX_CPU1_MD_RESETCTRS
wait 5

ut_tlmwait SCX_CPU1_MD_CMDPC, 0
if (UT_TW_Status = UT_Success) then
...
ut_tlmwait SCX_CPU1_MD_CMDEC, 0
if (UT_TW_Status = UT_Success) then
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1001) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",MD_RESET_CNTRS_DBG_EID, "."
  ut_setrequirements MD_1001, "F"
endif
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1005) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",MD_CMD_LEN_ERR_EID, "."
  ut_setrequirements MD_1005, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {MDAppName}, MD_CC_NOT_IN_TBL_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_MD_CMDEC + 1
;;; CPU1 is the default
rawcmd = "1890C0000001aa0000"
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1005) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",MD_CC_NOT_IN_TBL_ERR_EID, "."
  ut_setrequirements MD_1005, "F"
endif
...
/SCX_CPU1_MD_STARTDWELL TableMask=x'1000'
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1005) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",MD_EMPTY_TBLMASK_ERR_EID, "."
  ut_setrequirements MD_1005, "F"
endif
...
/SCX_CPU1_MD_STOPDWELL TableMask=x'1000'
...
/SCX_CPU1_MD_JAMDWELL TableId=1 EntryId=1 FieldLength=1 DwellDelay=1 Offset=x'FF' SymName="BogusSymbolMDGC"
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  write "<*> Passed (1006) - Event message ",SCX_CPU1_find_event[1].eventid, " received"
  ut_setrequirements MD_1006, "P"
else
  write "<!> Failed (1006) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",MD_CANT_RESOLVE_JAM_ADDR_ERR_EID, "."
  ut_setrequirements MD_1006, "F"
endif
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_md_GenCmds                                    "
write ";*********************************************************************"
ENDPROC
