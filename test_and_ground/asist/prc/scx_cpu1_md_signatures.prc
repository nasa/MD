...
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[2].MD_TLE_Length = 1
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[2].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[2].MD_TLE_Offset = testdata_addr+1
...
if (SCX_CPU1_EVS_EVENTID <> CFE_TBL_VALIDATION_INF_EID) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages != 1) then
    ...
    write "<*> Passed (3002) - Inactive Dwell Table #1 validated. Event Msg ",SCX_CPU1_evs_eventid," Found!"
...
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_Delay = 1
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_Offset = testdata_addr+2
...
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[3].MD_TLE_Length = 0
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[3].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[3].MD_TLE_Offset = 0
...
s create_tbl_file_from_cvt (hostCPU,dwell_tbl2_load_appid,"Dwell Table #2 Load", "md_dwl_ld_sg_tbl2",MDTblName2, "SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Enabled", "SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[3]")
...
if (SCX_CPU1_EVS_EVENTID <> CFE_TBL_VALIDATION_INF_EID) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages != 1) then
    ...
    write "<*> Passed (3002) - Inactive Dwell Table #2 validated. Event Msg ",SCX_CPU1_evs_eventid," Found!"
    ut_setrequirements MD_3002, "P"  
  endif
else
  write "<*> Passed (3002) - Inactive Dwell Table #2 validated. Event Msg ",SCX_CPU1_evs_eventid," Found!"
...
if (SCX_CPU1_EVS_EVENTID <> CFE_TBL_VALIDATION_INF_EID) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages != 1) then
    ...
    write "<*> Passed (3002) - Inactive Dwell Table #3 validated. Event Msg ",SCX_CPU1_evs_eventid," Found!"
    ut_setrequirements MD_3002, "P"  
  endif
else
  write "<*> Passed (3002) - Inactive Dwell Table #3 validated. Event Msg ",SCX_CPU1_evs_eventid," Found!"
...
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[1].MD_TLE_Length = 1
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[1].MD_TLE_Delay = 1
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[1].MD_TLE_Offset = testdata_addr+12
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[1].MD_TLE_SymName = ""

SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[2].MD_TLE_Length = 1
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[2].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[2].MD_TLE_Offset = testdata_addr+13
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[2].MD_TLE_SymName = ""

SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Length = 0
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Offset = 0
...
s create_tbl_file_from_cvt (hostCPU,dwell_tbl4_load_appid,"Dwell Table #4 Load", "md_dwl_ld_sg_tbl4",MDTblName4, "SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Enabled", "SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3]")
...
if (SCX_CPU1_EVS_EVENTID <> CFE_TBL_VALIDATION_INF_EID) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages != 1) then
    ...
    write "<*> Passed (3002) - Inactive Dwell Table #4 validated. Event Msg ",SCX_CPU1_evs_eventid," Found!"
    ut_setrequirements MD_3002, "P"  
  endif
else
  write "<*> Passed (3002) - Inactive Dwell Table #4 validated. Event Msg ",SCX_CPU1_evs_eventid," Found!"
...
ut_setupevents "SCX", "CPU1", {MDAppName}, MD_SET_SIGNATURE_INF_EID, "INFO", 1

ut_sendcmd "SCX_CPU1_MD_SetSignature TableId=1 Signature="""""
if (UT_SC_Status = UT_SC_Success) then
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", MD_SET_SIGNATURE_INF_EID, "."
  ut_setrequirements MD_1004, "F"
endif
...
s get_tbl_to_cvt (ramDir,MDTblName1,"A","cpu1_tbl1_sig2.1",hostCPU,dwell_tbl1_load_pkt)
...
if (SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Signature = "") then 
  write "<*> Passed (5000) - Signature was found in the table #1 dump."
  ut_setrequirements MD_5000, "P"
else
  write "<!> Failed (5000) - Expected Signature ''; Found '",SCX_CPU1_MD_DWELL_LOAD_TBL1.MD_DTL_Signature,"'."
  ut_setrequirements MD_5000, "F"
endif
...
ut_tlmwait SCX_CPU1_MD_DwlPkt1Signature, ""
if (UT_TW_Status = UT_Success) then
...
ut_sendcmd "SCX_CPU1_MD_SetSignature TableId=2 Signature=""1"""
if (UT_SC_Status = UT_SC_Success) then
  write "<*> Passed (1004;5000) - Set Signature command sent properly."
  ut_setrequirements MD_1004, "P"
  ut_setrequirements MD_5000, "P"
...
s get_tbl_to_cvt (ramDir,MDTblName2,"A","cpu1_tbl2_sig22",hostCPU,dwell_tbl2_load_pkt)
...
;; Check the Dwell Load Signature 
if (SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Signature = "1") then 
  write "<*> Passed (5000) - Signature was found in the table #2 dump."
  ut_setrequirements MD_5000, "P"
else
  write "<!> Failed (5000) - Expected Signature '1'; Found '",SCX_CPU1_MD_DWELL_LOAD_TBL2.MD_DTL_Signature,"'."
  ut_setrequirements MD_5000, "F"
endif
...
; Verify that memory dwell messages are received and contain the signature
ut_tlmwait SCX_CPU1_MD_DwlPkt2Signature, "1"
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (3001) - Signature appears in the dwell packet."
  ut_setrequirements MD_3001, "P"
else
...
ut_sendcmd "SCX_CPU1_MD_SetSignature TableId=3 Signature=""1234567890123456"""
if (UT_SC_Status = UT_SC_Success) then
  write "<*> Passed (1004;5000) - Set Signature command sent properly."
  ut_setrequirements MD_1004, "P"
  ut_setrequirements MD_5000, "P"
...
s get_tbl_to_cvt (ramDir,MDTblName3,"A","cpu1_tbl3_sig23",hostCPU,dwell_tbl3_load_pkt)
...
;; Check the Dwell Load Signature 
if (SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Signature = "1234567890123456") then 
  write "<*> Passed (5000) - Signature was found in the table #3 dump."
  ut_setrequirements MD_5000, "P"
else
  write "<!> Failed (5000) - Expected Signature '1234567890123456'; Found '",SCX_CPU1_MD_DWELL_LOAD_TBL3.MD_DTL_Signature,"'."
  ut_setrequirements MD_5000, "F"
endif
...
; Verify that memory dwell messages are received and contain the signature
ut_tlmwait SCX_CPU1_MD_DwlPkt3Signature, "1234567890123456"
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (3001) - Signature appears in the dwell packet."
  ut_setrequirements MD_3001, "P"
else
...
ut_sendcmd "SCX_CPU1_MD_SetSignature TableId=4 Signature=""1234567890123456789012345678901"""
if (UT_SC_Status = UT_SC_Success) then
  write "<*> Passed (1004;5000) - Set Signature command sent properly."
  ut_setrequirements MD_1004, "P"
  ut_setrequirements MD_5000, "P"
...
s get_tbl_to_cvt (ramDir,MDTblName4,"A","cpu1_tbl4_sig24",hostCPU,dwell_tbl4_load_pkt)
...
;; Check the Dwell Load Signature 
if (SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Signature = "1234567890123456789012345678901") then 
  write "<*> Passed (5000) - Signature was found in the table #4 dump."
  ut_setrequirements MD_5000, "P"
else
  write "<!> Failed (5000) - Expected Signature '1234567890123456789012345678901'; Found '",SCX_CPU1_MD_DWELL_LOAD_TBL4.MD_DTL_Signature,"'."
  ut_setrequirements MD_5000, "F"
endif
...
; Verify that memory dwell messages are received and contain the signature
ut_tlmwait SCX_CPU1_MD_DwlPkt4Signature, "1234567890123456789012345678901"
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (3001) - Signature appears in the dwell packet."
  ut_setrequirements MD_3001, "P"
else
...
SCX_CPU1_MD_DwlPkt1Signature = "Signature reset"
SCX_CPU1_MD_DwlPkt2Signature = "Signature reset"
SCX_CPU1_MD_DwlPkt3Signature = "Signature reset"
SCX_CPU1_MD_DwlPkt4Signature = "Signature reset"
...
if (SCX_CPU1_MD_EnableMask = b'1111') then
  ...
  /SCX_CPU1_MD_StartDwell TableMask=b'1111'

  ; Check MD_EnableMask
  ut_tlmwait SCX_CPU1_MD_EnableMask, b'1111'
  if (UT_TW_Status <> UT_Success) then
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {MDAppName}, MD_INIT_INF_EID, "INFO", 1
...
write ";*********************************************************************"
if (SCX_CPU1_MD_CMDPC != 0) OR (SCX_CPU1_MD_CMDEC != 0) THEN
...
write ";*********************************************************************"
write ";  Step 3.3.1: Command a Power-On Reset on CPU1. "
write ";********************************************************************"
/SCX_CPU1_ES_POWERONRESET
wait 10
...
for i = 1 to MD_NUM_DWELL_TABLES do
  ...
  dumpFileName = "cpu1_tbl" & i & "_md_sig338"
  if (i = 1) then
...
ut_setupevents "SCX", "CPU1", {MDAppName}, MD_INVALID_SIGNATURE_LENGTH_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_MD_CMDEC + 1

/SCX_CPU1_MD_SetSignature TableId=3 Signature="12345678901234567890123456789012"
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  write "<*> Passed (1005;5000.1) - Event message ",SCX_CPU1_find_event[1].eventid," received."
  ut_setrequirements MD_1005, "P"
  ut_setrequirements MD_5000_1, "P"
else
  write "<!> Failed (1005;5000.1) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",MD_INVALID_SIGNATURE_LENGTH_ERR_EID, "."
  ut_setrequirements MD_1005, "F"
  ut_setrequirements MD_5000_1, "F"
endif
...
s get_tbl_to_cvt (ramDir,MDTblName3,"A","cpu1_tbl3_sig41",hostCPU,dwell_tbl3_load_pkt)
...
;; Check the Dwell Load Signature 
if (SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Signature = "12345678901234567890123456789012") then 
...
write ";********************************************************************"
ut_setupevents "SCX", "CPU1", {MDAppName}, MD_CMD_LEN_ERR_EID, "ERROR", 1
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1002;1005) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", MD_CMD_LEN_ERR_EID, "."
  ut_setrequirements MD_1002, "F"
  ut_setrequirements MD_1005, "F"
endif
...
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_Delay = 1
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_Offset = testdata_addr+32
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[1].MD_TLE_SymName = ""

SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Offset = testdata_addr+36
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_SymName = ""

SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[3].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[3].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[3].MD_TLE_Offset = testdata_addr+38
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[3].MD_TLE_SymName = ""

SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[4].MD_TLE_Length = 0
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[4].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[4].MD_TLE_Offset = 0
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[4].MD_TLE_SymName = ""

; Create a load file for dwell table #2 with this data (including signature)
ut_setupevents SCX, CPU1, CFE_TBL, CFE_TBL_FILE_LOADED_INF_EID, INFO, 1

s create_tbl_file_from_cvt (hostCPU,dwell_tbl2_load_appid,"Dwell Table #2 Load", "md_dwl_ld_sg_tbl2",MDTblName2, "SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Enabled", "SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[4]")
...
wait until (SCX_CPU1_RF[dwl_tbl_2_index].SCX_CPU1_TBL_LOADBUFFERID <> -1)
...
if (SCX_CPU1_EVS_EVENTID <> CFE_TBL_VALIDATION_INF_EID) then
  ...
  if (SCX_CPU1_find_event[1].num_found_messages != 1) then
    ...
    write "<*> Passed (3002) - Dwell Table #2 validated. Event Msg ",SCX_CPU1_evs_eventid," Found!"
    ut_setrequirements MD_3002, "P"  
  endif
else
  write "<*> Passed (3002) - Dwell Table #2 validated. Event Msg ",SCX_CPU1_evs_eventid," Found!"
...
/SCX_CPU1_MD_STARTDWELL TableMask=b'0010'
page SCX_CPU1_MD_DWELL_PKT2
wait 5

; Verify that memory dwell messages are received and contain the signature
ut_tlmwait SCX_CPU1_MD_DwlPkt2Signature, "Table #2 with signature"
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (3001) - Signature appears in the dwell packet for Tbl #2."
  ut_setrequirements MD_3001, "P"
else
  write "<!> Failed (3001) - Signature in dwell packet is '",SCX_CPU1_MD_DwlPkt2Signature, "'. Expected 'Table #2 with signature'."
  ut_setrequirements MD_3001, "F"
endif
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_md_Signatures                               "
write ";*********************************************************************"
ENDPROC
