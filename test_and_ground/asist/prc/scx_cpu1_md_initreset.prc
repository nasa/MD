...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=1 EntryId=1 FieldLength=4 DwellDelay=1 Offset=workaddress SymName="""""
...
s get_tbl_to_cvt (ramDir,MDTblName1,"A","cpu1_initreset211",hostCPU,dwell_tbl1_load_pkt)
...
if (SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Length = 4) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Delay = 1) AND ;;
  ...
  write "- Expected Delay of 1 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Delay
...
s get_tbl_to_cvt (ramDir,MDTblName1,"A","cpu1_initreset215",hostCPU,dwell_tbl1_load_pkt)
...
if (SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Length = 4) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Delay = 1) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Offset = tbl1JamAddr) then
  ...
  write "- Expected Length of 4 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Length
  write "- Expected Delay of 1 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Delay
  write "- Expected Offset of ",tbl1JamAddr, " - table = ",SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Offset
  ut_setrequirements MD_9004, "F"
endif

; FIRST table should have address count 2, rate 1 and data size 5
if (SCX_CPU1_MD_AddrCnt[1] = 2) and (SCX_CPU1_MD_Rate[1] = 1) and (SCX_CPU1_MD_DataSize[1] = 5) THEN
  ...
  write "SCX_CPU1_MD_AddrCnt[1] = ", SCX_CPU1_MD_AddrCnt[1], " (Expected 2)"
  write "SCX_CPU1_MD_Rate[1] = ", SCX_CPU1_MD_Rate[1], " (Expected 1)"
  write "SCX_CPU1_MD_DataSize[1] = ", SCX_CPU1_MD_DataSize[1], " (Expected 5)"
  ut_setrequirements MD_9004, "F"
endif
...
if (SCX_CPU1_MD_AddrCnt[2] = 2) and (SCX_CPU1_MD_Rate[2] = 1) and (SCX_CPU1_MD_DataSize[2] = 4) THEN
  ...
  write "SCX_CPU1_MD_Rate[2] = ", SCX_CPU1_MD_Rate[2], " (Expected 1)"
  write "SCX_CPU1_MD_DataSize[2] = ", SCX_CPU1_MD_DataSize[2], " (Expected 4)"
  ut_setrequirements MD_9004, "F"
endif
...
if (SCX_CPU1_MD_AddrCnt[3] = 2) and (SCX_CPU1_MD_Rate[3] = 1) and (SCX_CPU1_MD_DataSize[3] = 6) THEN
  ...
  write "SCX_CPU1_MD_AddrCnt[3] = ", SCX_CPU1_MD_AddrCnt[3], " (Expected 2)"
  write "SCX_CPU1_MD_Rate[3] = ", SCX_CPU1_MD_Rate[3], " (Expected 1)"
  write "SCX_CPU1_MD_DataSize[3] = ", SCX_CPU1_MD_DataSize[3], " (Expected 6)"
  ut_setrequirements MD_9004, "F"
endif
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=2 EntryId=2 FieldLength=1 DwellDelay=1 Offset=workaddress SymName="""""
if (UT_SC_Status = UT_SC_Success) then
  write "<*> Passed (1004,4000) - Jam Dwell command sent properly."
  ut_setrequirements MD_1004, "P"
  ut_setrequirements MD_4000, "P"
...
s get_tbl_to_cvt (ramDir,MDTblName2,"A","cpu1_initreset221",hostCPU,dwell_tbl2_load_pkt)
...
;; Check the table entry to see if it corresponds to what was jammed
if (SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Length = 1) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Delay = 1) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Offset = workaddress) then
  write "<*> Passed (4000;9003) - The jammed entry has been found in the table."
  ut_setrequirements MD_4000, "P"
  ut_setrequirements MD_9003, "P"
else
  write "<!> Failed (4000;9003) - The table did not contain the jammed entry."
  write "- Expected Length of 1 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Length
  write "- Expected Delay of 1 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Delay
  write "- Expected Offset of ",workaddress, " - table = ",SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Offset
  ut_setrequirements MD_4000, "F"
  ut_setrequirements MD_9003, "F"
endif
...
s get_tbl_to_cvt (ramDir,MDTblName1,"A","cpu1_tbl1_reset225",hostCPU,dwell_tbl1_load_pkt)
...
s get_tbl_to_cvt (ramDir,MDTblName2,"A","cpu1_tbl2_reset225",hostCPU,dwell_tbl2_load_pkt)
...
if (SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Length = 1) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Delay = 1) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Offset = tbl2JamAddr) then
  ...
  write "- Expected Length of 1 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Length
  write "- Expected Delay of 1 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Delay
  write "- Expected Offset of ",tbl2JamAddr, " - table = ",SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[2].MD_TLE_Offset
  ut_setrequirements MD_9004, "F"
endif

; SECOND table should have address count 2, rate 2 and data size 3
if (SCX_CPU1_MD_AddrCnt[2] = 2) and (SCX_CPU1_MD_Rate[2] = 2) and (SCX_CPU1_MD_DataSize[2] = 3) THEN
  write "<*> Passed (9004) - SECOND Dwell Table has correct address count, rate and data size!"
  ut_setrequirements MD_9004, "P"
else
  write "<!> Failed (9004) - SECOND Dwell Table does not have correct address count, rate and data size!"
  ...
  write "SCX_CPU1_MD_DataSize[2] = ", SCX_CPU1_MD_DataSize[2], " (Expected 3)"
  ut_setrequirements MD_9004, "F"
endif
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=4 EntryId=3 FieldLength=2 DwellDelay=0 Offset=workaddress SymName="""""
if (UT_SC_Status = UT_SC_Success) then
  write "<*> Passed (1004,4000) - Jam Dwell command sent properly."
  ut_setrequirements MD_1004, "P"
else
...
ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=4 EntryId=4 FieldLength=0 DwellDelay=0 Offset=0 SymName="""""
if (UT_SC_Status = UT_SC_Success) then
  write "<*> Passed (1004,4000) - Jam Dwell command sent properly."
  ut_setrequirements MD_1004, "P"
  ut_setrequirements MD_4000, "P"
...
s get_tbl_to_cvt (ramDir,MDTblName4,"A","cpu1_tbl4_reset231",hostCPU,dwell_tbl4_load_pkt)
...
;; Check the table entry to see if it corresponds to what was jammed
if (SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Length = 2) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Delay = 0) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Offset = workaddress) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Length = 0) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Delay = 0) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Offset = 0) then
  ...
  write "- Expected Length of 1 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Length
  write "- Expected Delay of 1 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Delay
  write "- Expected Offset of ",workaddress, " - table = ",SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Offset
  write "- Expected Length of 0 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Length
  write "- Expected Delay of 0 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Delay
  write "- Expected Offset of 0 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Offset
  ut_setrequirements MD_4000, "F"
  ut_setrequirements MD_9004, "F"
endif
...
s get_tbl_to_cvt (ramDir,MDTblName1,"A","cpu1_tbl1_reset235",hostCPU,dwell_tbl1_load_pkt)
...
s get_tbl_to_cvt (ramDir,MDTblName2,"A","cpu1_tbl2_reset235",hostCPU,dwell_tbl2_load_pkt)
...
s get_tbl_to_cvt (ramDir,MDTblName4,"A","cpu1_tbl4_reset235",hostCPU,dwell_tbl4_load_pkt)
...
if (SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Length = 2) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Delay = 0) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Offset = tbl4JamAddr) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Length = 0) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Delay = 0) AND ;;
   (SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Offset = 0) then
  ...
  write "- Expected Length of 1 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Length
  write "- Expected Delay of 1 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Delay
  write "- Expected Offset of ",tbl4JamAddr, " - table = ",SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Offset
  write "- Expected Length of 0 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Length
  write "- Expected Delay of 0 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Delay
  write "- Expected Offset of 0 - table = ",SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Offset
  ut_setrequirements MD_9004, "F"
...
if (SCX_CPU1_MD_AddrCnt[4] = 3) and (SCX_CPU1_MD_Rate[4] = 1) and (SCX_CPU1_MD_DataSize[4] = 4) THEN
  write "<*> Passed (9004) - LAST Dwell Table has correct address count, rate and data size!"
  ut_setrequirements MD_9004, "P"
else
  write "<!> Failed (9004) - LAST Dwell Table does not have correct address count, rate and data size!"
  write "SCX_CPU1_MD_AddrCnt[4] = ", SCX_CPU1_MD_AddrCnt[4], " (Expected 3)"
  write "SCX_CPU1_MD_Rate[4] = ", SCX_CPU1_MD_Rate[4], " (Expected 1)"
  write "SCX_CPU1_MD_DataSize[4] = ", SCX_CPU1_MD_DataSize[4], " (Expected 4)"
  ut_setrequirements MD_9004, "F"
endif
...
ut_sendcmd "SCX_CPU1_MD_StartDwell TableMask=b'1001'"
if (UT_SC_Status = UT_SC_Success) then
...
FOR i = 1 to MD_NUM_DWELL_TABLES DO
  write "  DwPktOffset[", i, "] = ", SCX_CPU1_MD_DwPktOffset[i]
  write "  DwTblEntry[", i, "]  = ", SCX_CPU1_MD_DwTblEntry[i]
ENDDO

;; Set variables for each MD table to check after reset
;; NOTE: THIS CODE ASSUMES ONLY 4 TABLES which is the delivered DEFAULT
local offsetTbl1 = SCX_CPU1_MD_DwPktOffset[1]
local entryTbl1 = SCX_CPU1_MD_DwTblEntry[1]
local offsetTbl2 = SCX_CPU1_MD_DwPktOffset[2]
local entryTbl2 = SCX_CPU1_MD_DwTblEntry[2]
local offsetTbl3 = SCX_CPU1_MD_DwPktOffset[3]
local entryTbl3 = SCX_CPU1_MD_DwTblEntry[3]
local offsetTbl4 = SCX_CPU1_MD_DwPktOffset[4]
local entryTbl4 = SCX_CPU1_MD_DwTblEntry[4]
...
s get_tbl_to_cvt (ramDir,MDTblName1,"A","cpu1_tbl1_reset245",hostCPU,dwell_tbl1_load_pkt)
...
s get_tbl_to_cvt (ramDir,MDTblName2,"A","cpu1_tbl2_reset245",hostCPU,dwell_tbl2_load_pkt)
...
s get_tbl_to_cvt (ramDir,MDTblName4,"A","cpu1_tbl4_reset245",hostCPU,dwell_tbl4_load_pkt)
...
;; Set variables for each MD table to check after reset
;; NOTE: THIS CODE ASSUMES ONLY 4 TABLES which is the delivered DEFAULT
offsetTbl1 = SCX_CPU1_MD_DwPktOffset[1]
entryTbl1 = SCX_CPU1_MD_DwTblEntry[1]
offsetTbl2 = SCX_CPU1_MD_DwPktOffset[2]
entryTbl2 = SCX_CPU1_MD_DwTblEntry[2]
offsetTbl3 = SCX_CPU1_MD_DwPktOffset[3]
entryTbl3 = SCX_CPU1_MD_DwTblEntry[3]
offsetTbl4 = SCX_CPU1_MD_DwPktOffset[4]
entryTbl4 = SCX_CPU1_MD_DwTblEntry[4]
...
ut_setupevents "SCX","CPU1","CFE_ES", CFE_ES_START_INF_EID, "INFO", 1
ut_setupevents "SCX","CPU1",{MDAppName},MD_TBL_INIT_INF_EID,"INFO", 2
ut_setupevents "SCX","CPU1",{MDAppName},MD_RECOVERED_TBL_VALID_INF_EID,"INFO", 3
ut_setupevents "SCX","CPU1",{MDAppName},MD_INIT_INF_EID, "INFO", 4
...
if (SCX_CPU1_find_event[2].num_found_messages = 1) AND ;;
   (SCX_CPU1_find_event[3].num_found_messages = 3) then
...
passed = 1
;; Check the Offset values
if (SCX_CPU1_MD_DwPktOffset[1] != 0) then
  passed = 0;
...
;; Check the Entry values
if (SCX_CPU1_MD_DwTblEntry[1] != 0) then
  passed = 0;
...
write ";*********************************************************************"
; Check MD_EnableMask
if (SCX_CPU1_MD_EnableMask = b'1000') then
...
s get_tbl_to_cvt (ramDir,MDTblName1,"A","cpu1_tbl1_reset255",hostCPU,dwell_tbl1_load_pkt)
...
if (SCX_CPU1_MD_AddrCnt[1] = 0) and (SCX_CPU1_MD_Rate[1] = 0) and (SCX_CPU1_MD_DataSize[1] = 0) THEN
  ...
  write "SCX_CPU1_MD_AddrCnt[1] = ", SCX_CPU1_MD_AddrCnt[1], " (Expected 0)"
  write "SCX_CPU1_MD_Rate[1] = ", SCX_CPU1_MD_Rate[1], " (Expected 0)"
  write "SCX_CPU1_MD_DataSize[1] = ", SCX_CPU1_MD_DataSize[1], " (Expected 0)"
  ut_setrequirements MD_9004, "F"
  ut_setrequirements MD_9004_1, "F"
endif
...
s get_tbl_to_cvt (ramDir,MDTblName2,"A","cpu1_tbl2_reset255",hostCPU,dwell_tbl2_load_pkt)
...
s get_tbl_to_cvt (ramDir,MDTblName4,"A","cpu1_tbl4_reset255",hostCPU,dwell_tbl4_load_pkt)
...
write ";*********************************************************************"
write ";  Step 2.6.1: Command a Power-On Reset on CPU1. "
write ";********************************************************************"
/SCX_CPU1_ES_POWERONRESET
wait 10
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_md_InitReset  "
write ";*********************************************************************"
ENDPROC
