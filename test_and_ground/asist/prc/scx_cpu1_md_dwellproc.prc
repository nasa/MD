...
;   09/09/08    S. Jonke    Original Procedure
...
write "; Skipping Step 1.1 since TST_MD is in the startup script. "
;write ";*********************************************************************"
...
write "; Skipping Step 1.2 since MD is in the startup script. "
;write ";*********************************************************************"
...
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Signature="Table with signature"

; Entry #1
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Length = 1
...
; Terminator entry
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[2].MD_TLE_Length = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[2].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[2].MD_TLE_Offset = 0
...
s create_tbl_file_from_cvt (hostCPU,dwell_tbl1_load_appid,"Dwell Table #1 Load", "md_dwl_ld_sg_tbl1",MDTblName1, "SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Enabled", "SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[2]")
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1004): Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", CFE_TBL_FILE_LOADED_INF_EID, "."
  ut_setrequirements MD_1004, "F"
endif
...
if (SCX_CPU1_find_event[2].num_found_messages = 1) then
  write "<*> Passed (3002) - Dwell Table #1 Activated. Event Msg ",SCX_CPU1_find_event[2].eventid," Found!"
...
ut_sendcmd "SCX_CPU1_MD_StartDwell TableMask=b'0001'"
if (UT_SC_Status = UT_SC_Success) then
...
; Check MD_EnableMask
if (SCX_CPU1_MD_EnableMask = b'0001') then
...
ut_setupevents "SCX", "CPU1", "TST_MD", TST_MD_STARTDATA_INF_EID, "INFO", 1

/SCX_CPU1_TST_MD_StartData
wait 5

if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  write "<*> Passed - Event message ",SCX_CPU1_find_event[1].eventid, " received"
else
  write "<!> Failed - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", TST_MD_STARTDATA_INF_EID, "."
endif

ut_tlmwait  SCX_CPU1_TST_MD_DATASTATE, 1
IF (UT_TW_Status = UT_Success) THEN
...
IF (SCX_CPU1_MD_DwlPkt1TableId = 1) THEN
...
IF (SCX_CPU1_MD_DwlPkt1NumAddresses = 1) THEN
...
IF (scx_cpu1_MD_DwlPkt1PktDataSize = 1) THEN
...
IF (scx_cpu1_MD_DwlPkt1Rate = 1) THEN
...
for i = 1 to 30 do
  ...
  dwelldata[i,1] = SCX_CPU1_MD_DwlPkt1DwellData[1]
  dwelldata[i,2] = SCX_CPU1_MD_DwlPkt1DwellData[2]
  dwelldata[i,3] = SCX_CPU1_MD_DwlPkt1DwellData[3]
  dwelldata[i,4] = SCX_CPU1_MD_DwlPkt1DwellData[4]
  dwelldata[i,5] = SCX_CPU1_MD_DwlPkt1DwellData[5]
  dwelldata[i,6] = SCX_CPU1_MD_DwlPkt1DwellData[6]
enddo
...
;; Set the table signature
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Signature="Table with signature"
...
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[12].MD_TLE_Delay = 4
...
; Terminator entry
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[13].MD_TLE_Length = 0
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[13].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[13].MD_TLE_Offset = 0
...
s create_tbl_file_from_cvt (hostCPU,dwell_tbl2_load_appid,"Dwell Table #2 Load", "md_dwl_ld_sg_tbl2",MDTblName2, "SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Enabled", "SCX_CPU1_MD_Dwell_Load_Tbl2.MD_DTL_Entry[13]")
...
if (SCX_CPU1_find_event[2].num_found_messages = 1) then
  write "<*> Passed (3002) - Dwell Table #2 Activated. Event Msg ",SCX_CPU1_find_event[2].eventid," Found!"
  ut_setrequirements MD_3002, "P"
else
...
ut_sendcmd "SCX_CPU1_MD_StartDwell TableMask=b'0010'"
if (UT_SC_Status = UT_SC_Success) then
  write "<*> Passed (1004;2000) - Start Dwell command sent properly."
  ut_setrequirements MD_1004, "P"
  ut_setrequirements MD_2000, "P"
...
; Check MD_EnableMask
if (SCX_CPU1_MD_EnableMask = b'0011') then
...
; Verify table id of the packet
IF (SCX_CPU1_MD_DwlPkt2TableId = 2) THEN
...
; Verify number of addresses of the packet
IF (SCX_CPU1_MD_DwlPkt2NumAddresses = 12) THEN
...
; Verify number of bytes of data of the packet
IF (scx_cpu1_MD_DwlPkt2PktDataSize = 30) THEN
...
; Verify rate of the packet
IF (scx_cpu1_MD_DwlPkt2Rate = 4) THEN
...
ut_tlmwait  SCX_CPU1_MD_DwlPkt2TableId, 2
...
for i = 1 to 15 do
  ...
  ; Collect the data from the packet
  for j = 1 to 34 do
    dwelldata[i,j] = SCX_CPU1_MD_DwlPkt2DwellData[j]
  enddo
enddo
...
;; Set the table signature
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Signature="Table with signature"
...
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[25].MD_TLE_Delay = 0
...
if (SCX_CPU1_find_event[2].num_found_messages = 1) then
  write "<*> Passed (3002) - Dwell Table #4 Activated. Event Msg ",SCX_CPU1_find_event[2].eventid," Found!"
  ut_setrequirements MD_3002, "P"
else
...
ut_sendcmd "SCX_CPU1_MD_StartDwell TableMask=b'1000'"
if (UT_SC_Status = UT_SC_Success) then
  write "<*> Passed (1004;2000) - Start Dwell command sent properly."
  ut_setrequirements MD_1004, "P"
  ut_setrequirements MD_2000, "P"
...
; Check MD_EnableMask
if (SCX_CPU1_MD_EnableMask = b'1011') then
...
; Verify table id of the packet
IF (SCX_CPU1_MD_DwlPkt4TableId = 4) THEN
...
; Verify number of addresses of the packet
IF (SCX_CPU1_MD_DwlPkt4NumAddresses = 25) THEN
  write "<*> Passed (3001) - Dwell packet for table 4 has correct number of addresses"
  ut_setrequirements MD_3001, "P"
else
  write "<!> Failed (3001) - Dwell packet for table 4 does NOT have correct number of addresses! Expected 25. Table has ",SCX_CPU1_MD_DwlPkt4NumAddresses
  ut_setrequirements MD_3001, "F"
endif

; Verify number of bytes of data of the packet
IF (scx_cpu1_MD_DwlPkt4PktDataSize = 58) THEN
  write "<*> Passed (3001) - Dwell packet for table 4 has correct data size"
  ut_setrequirements MD_3001, "P"
else
  write "<!> Failed (3001) - Dwell packet for table 4 does NOT have correct data size! Expected 58. Table has ",scx_cpu1_MD_DwlPkt4PktDataSize 
  ut_setrequirements MD_3001, "F"
endif

; Verify rate of the packet
IF (scx_cpu1_MD_DwlPkt4Rate = 5) THEN
  write "<*> Passed (3001) - Dwell packet for table 4 has correct data rate"
  ut_setrequirements MD_3001, "P"
else
  write "<!> Failed (3001) - Dwell packet for table 4 does NOT have correct data rate! Expected 5. Table has ", scx_cpu1_MD_DwlPkt4Rate 
  ut_setrequirements MD_3001, "F"
endif
...
;  ut_tlmupdate {"p" & dwell_pkt4_appid & "scnt"}, 10
  ...
  ; Collect the data from the packet
  for j = 1 to 62 do
    dwelldata[i,j] = SCX_CPU1_MD_DwlPkt4DwellData[j]
  enddo
enddo
...
;; Set the table signature
SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Signature="Table with signature"

; Entry #1
SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[1].MD_TLE_Length = 4
SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[1].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[1].MD_TLE_Offset = testdata_addr
...
SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[2].MD_TLE_Offset = testdata_addr+4
SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[2].MD_TLE_SymName = ""

; Entry #3
SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[3].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[3].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[3].MD_TLE_Offset = testdata_addr+8
SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[3].MD_TLE_SymName = ""

; Terminator entry
SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[4].MD_TLE_Length = 0
SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[4].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[4].MD_TLE_Offset = 0
SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[4].MD_TLE_SymName = ""

; Create a load file for dwell table #3 with this data (including signature)
ut_setupevents SCX, CPU1, CFE_TBL, CFE_TBL_FILE_LOADED_INF_EID, INFO, 1

s create_tbl_file_from_cvt (hostCPU,dwell_tbl3_load_appid,"Dwell Table #3 Load", "md_dwl_ld_sg_tbl3",MDTblName3, "SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Enabled", "SCX_CPU1_MD_Dwell_Load_Tbl3.MD_DTL_Entry[4]")
...
if (SCX_CPU1_find_event[2].num_found_messages = 1) then
  write "<*> Passed (3002) - Dwell Table #3 Activated. Event Msg ",SCX_CPU1_find_event[2].eventid," Found!"
  ut_setrequirements MD_3002, "P"
else
...
ut_sendcmd "SCX_CPU1_MD_StartDwell TableMask=b'0100'"
if (UT_SC_Status = UT_SC_Success) then
  write "<*> Passed (1004;2000) - Start Dwell command sent properly."
  ut_setrequirements MD_1004, "P"
  ut_setrequirements MD_2000, "P"
...
ut_setupevents "SCX", "CPU1", {MDAppName}, MD_STOP_DWELL_INF_EID, "INFO", 1

ut_sendcmd "SCX_CPU1_MD_StopDwell TableMask=b'1111'"
if (UT_SC_Status = UT_SC_Success) then
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", MD_STOP_DWELL_INF_EID, "."
  ut_setrequirements MD_1004, "F"
endif

; Check MD_EnableMask
if (SCX_CPU1_MD_EnableMask = b'0000') then
...
write ";********************************************************************"
ut_setupevents "SCX", "CPU1", {MDAppName}, MD_JAM_NULL_DWELL_INF_EID, "INFO", 1

ut_sendcmd "SCX_CPU1_MD_JAMDWELL TableId=1 EntryId=1 FieldLength=0 DwellDelay=0 Offset=0 SymName="""""
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ", MD_JAM_NULL_DWELL_INF_EID, "."
  ut_setrequirements MD_1004, "F"
endif
...
; Entry #1
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[1].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[1].MD_TLE_Delay = 1
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[1].MD_TLE_Offset = testdata_addr+0
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[1].MD_TLE_SymName = ""

; Entry #2
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[2].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[2].MD_TLE_Delay = 3
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[2].MD_TLE_Offset = testdata_addr+0
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[2].MD_TLE_SymName = ""

; Entry #3
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_Offset = testdata_addr+2
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[3].MD_TLE_SymName = ""

; Entry #4
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Delay = 1
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_Offset = testdata_addr+0
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[4].MD_TLE_SymName = ""

; Entry #5
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[5].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[5].MD_TLE_Delay = 1
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[5].MD_TLE_Offset = testdata_addr+0
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[5].MD_TLE_SymName = ""

; Entry #6 - Terminator Entry
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[6].MD_TLE_Length = 0
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[6].MD_TLE_Delay = 0
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[6].MD_TLE_Offset = 0
SCX_CPU1_MD_Dwell_Load_Tbl4.MD_DTL_Entry[6].MD_TLE_SymName = ""
...
; Check MD_EnableMask
if (SCX_CPU1_MD_EnableMask = b'1001') then
...
; Verify number of addresses of the packet
IF (SCX_CPU1_MD_DwlPkt4NumAddresses = 5) THEN
  write "<*> Passed (3001) - Dwell packet for table 4 has correct number of addresses"
  ut_setrequirements MD_3001, "P"
else
...
; Verify number of bytes of data of the packet
IF (scx_cpu1_MD_DwlPkt4PktDataSize = 10) THEN
  write "<*> Passed (3001) - Dwell packet for table 4 has correct data size"
  ut_setrequirements MD_3001, "P"
else
...
; Verify rate of the packet
IF (scx_cpu1_MD_DwlPkt4Rate = 6) THEN
  write "<*> Passed (3001) - Dwell packet for table 4 has correct data rate"
  ut_setrequirements MD_3001, "P"
else
...
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Delay = 1
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Offset = 50
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_SymName = "Invalid"
...
ut_setupevents "SCX","CPU1",{MDAppName},MD_RESOLVE_ERR_EID,"ERROR", 3
...
if (SCX_CPU1_find_event[2].num_found_messages = 1) then
  write "<*> Passed (3002;3002.2) - Inactive Dwell Table 1 failed validation as expected. Event Msg ",SCX_CPU1_find_event[2].eventid," Found!"
  ut_setrequirements MD_3002, "P"
...
if (SCX_CPU1_find_event[3].num_found_messages = 1) then
  write "<*> Passed (3002.2) - Validation failed due to unresolved symbol. Event Msg ",SCX_CPU1_find_event[3].eventid," Found!"
  ut_setrequirements MD_3002_2, "P"
else
...
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Delay = 1
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Offset = x'8000004'
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_SymName = ""
...
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VAL_REQ_MADE_INF_EID,"DEBUG", 1
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VALIDATION_ERR_EID,"ERROR", 2
ut_setupevents "SCX","CPU1",{MDAppName},MD_RANGE_ERR_EID,"ERROR", 3
...
if (SCX_CPU1_find_event[3].num_found_messages = 1) then
  write "<*> Passed (3002.2) - Validation failed due to invalid address. Event Msg ",SCX_CPU1_find_event[3].eventid," Found!"
  ut_setrequirements MD_3002_2, "P"
else
...
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Length = 2
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Delay = 1
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Offset = 1
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_SymName = ""
...
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VAL_REQ_MADE_INF_EID,"DEBUG", 1
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VALIDATION_ERR_EID,"ERROR", 2
ut_setupevents "SCX","CPU1",{MDAppName},MD_TBL_ALIGN_ERR_EID,"ERROR", 3
...
if (SCX_CPU1_find_event[3].num_found_messages = 1) then
  write "<*> Passed (3002.2) - Validation failed due to address unaligned. Event Msg ",SCX_CPU1_find_event[3].eventid," Found!"
  ut_setrequirements MD_3002_2, "P"
else
...
; Entry #1
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Length = 4
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Delay = 1
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Offset = 2
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_SymName = ""
...
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VALIDATION_ERR_EID,"ERROR", 2
ut_setupevents "SCX","CPU1",{MDAppName},MD_TBL_ALIGN_ERR_EID,"ERROR", 3
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VALIDATION_INF_EID,"INFO", 4
...
if (MD_ENFORCE_DWORD_ALIGN = 1) then
  ...
  if (SCX_CPU1_find_event[4].num_found_messages = 1) then
    write "<*> Passed (3002;3002.2) - Inactive Dwell Table 1 passed validation with an unaligned entry as expected. Event Msg ",SCX_CPU1_find_event[4].eventid," Found!"
    ut_setrequirements MD_3002, "P"
    ut_setrequirements MD_3002_2, "P"
  else
...
; Entry #1
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Length = 3
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Delay = 1
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_Offset = 0
SCX_CPU1_MD_Dwell_Load_Tbl1.MD_DTL_Entry[1].MD_TLE_SymName = ""
...
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VAL_REQ_MADE_INF_EID,"DEBUG", 1
ut_setupevents "SCX","CPU1","CFE_TBL", CFE_TBL_VALIDATION_ERR_EID,"ERROR", 2
ut_setupevents "SCX","CPU1",{MDAppName}, MD_TBL_HAS_LEN_ERR_EID,"ERROR", 3
...
if (SCX_CPU1_find_event[3].num_found_messages = 1) then
  write "<*> Passed (3002.2) - Validation failed due to invalid length. Event Msg ",SCX_CPU1_find_event[3].eventid," Found!"
  ut_setrequirements MD_3002_5, "P"
else
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_md_DwellProc                                "
write ";*********************************************************************"
ENDPROC
