...
#define MD_TBL_ENA_FLAG_ERROR \
    (0xc0000001) /**< \brief Enable flag in table load is invalid (valid values are 0 and 1) */

#define MD_ZERO_RATE_TBL_ERROR \
    (0xc0000002) /**< \brief Table has zero value for total delay, and at least one dwell specified */
...
typedef struct
{
    uint16 Enabled; /**< \brief Is table is enabled for dwell?  Valid values are #MD_DWELL_STREAM_DISABLED,
                       #MD_DWELL_STREAM_ENABLED */
...
**          None
**
** \param[in] BufPtr a pointer to the message received from the command pipe
**
** \retval None
******************************************************************************/
