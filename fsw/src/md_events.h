...
/** \brief <tt> 'Msg with Invalid message ID Rcvd -- ID = 0x%08X' </tt>
**  \event <tt> 'Msg with Invalid message ID Rcvd -- ID = 0x%08X' </tt>
**
**  \par Type: ERROR
**
**  \par Cause:
...
/** \brief <tt> 'Cmd Msg with Bad length Rcvd: ID = 0x%08X, CC = %d, Exp Len = %d, Len = %d' </tt>
**  \event <tt> 'Cmd Msg with Bad length Rcvd: ID = 0x%08X, CC = %d, Exp Len = %d, Len = %d' </tt>
**
**  \par Type: ERROR
**
**  \par Cause:
...
/** \brief <tt> 'Msg with Bad length Rcvd: ID = 0x%08X, Exp Len = %d, Len = %d' </tt>
**  \event <tt> 'Msg with Bad length Rcvd: ID = 0x%08X, Exp Len = %d, Len = %d' </tt>
**
**  \par Type: ERROR
**
**  \par Cause:
...
/** \brief <tt> 'Dwell Table rejected because address (sym='%s'/offset=0x08X) in entry #%d is not properly aligned for a
*%d-byte dwell' </tt>
**  \event <tt> 'Dwell Table rejected because address (sym='%s'/offset=0x08X) in entry #%d is not properly aligned for a
*%d-byte dwell' </tt>
**
**  \par Type: ERROR
**
...
/** \brief <tt> 'Table entry %d failed with status 0x%08X' </tt>
**  \event <tt> 'Table entry %d failed with status 0x%08X' </tt>
**
**  \par Type: ERROR
**
**  \par Cause:
